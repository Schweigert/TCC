...
Na pequisa referenciada serão levantadas arquiteturas da literatura, buscando as mais adequadas ao escopo deste trabalho. Será dividido em três situações: levantamento de arquiteturas de microsserviços descritas na literatura e caracterização dessas arquiteturas.
%
Por fim, o levantamento e caracterização de possíveis simulações para efetuar testes durante a pesquisa aplicada.

Na pesquisa aplicada, o resultado a ser obtido é a análise das arquiteturas de microsserviços caracterizadas, visando uma análise sobre os recursos computacionais consumidos e identificação de seus gargalos.
%
...
\begin{enumerate}
  ...
  \item \textbf{Identificação e caracterização de arquiteturas descritas na literatura:} Enumeração e caracterização das arquiteturas de microsserviços descritas na literatura, bem como os seus objetivos;
  ...
  \item \textbf{Otimização para melhorar as métricas obtidas:} Analisar pontos de gargalo nos microsserviços analisados e propor soluções viáveis para aumentar o desempenho desses sistemas.
