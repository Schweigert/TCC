...
Análise e caracterização de arquiteturas de microsserviços empregados a jogos MMORPG voltada a otimização do uso de recursos de gerenciamento de mundos virtuais
}
...
\noindent
  ...
  %
  Os resultados obtidos auxiliarão provedores de serviços MMORPG a reduzir gastos de manutenção e melhorar a qualidade de tais serviços.
