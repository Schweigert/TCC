...
\begin{table}[htb!]
  ...
  \begin{tabular}{|l|l|}
  \hline
  Recrusos                                                                                                                                                                   & Motivo Possível                                                                                                           \\ \hline
  \begin{tabular}[c]{@{}l@{}}Elevado consumo de CPU\\ Elevado tempo de resposta\\ baixo número de conexões\end{tabular}                                                      & \begin{tabular}[c]{@{}l@{}}Conjunto inadequado de algoritmos\\ ou poder de processamento baixo\\ do serviço.\end{tabular} \\ \hline
  \begin{tabular}[c]{@{}l@{}}Elevado consumo de Memória\\ Elevado tempo de resposta\\ Baixo número de conexões\end{tabular}                                                  & \begin{tabular}[c]{@{}l@{}}Conjunto inadequado de algoritmos\\ para o consumo de memória\end{tabular}                     \\ \hline
  \begin{tabular}[c]{@{}l@{}}Elevado número de conexões\\ Elevado tempo de resposta\\ Elevado consumo de Rede\\ Baixo consumo de CPU\\ Baixo consumo de memória\end{tabular} & Protocolo inadequado para o serviço                                                                                       \\ \hline
  \end{tabular}
