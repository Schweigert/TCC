...
Os testes que serão executados sobre as redes são baseados obter valores dos recursos mínimos para execução dos serviços e o seu crescimento conforme um número de clientes simultâneos. %ccm <-16,11
