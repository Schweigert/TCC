...
Não foi encontrado trabalhos para guiar a caracterização dos dados sendo atualmente exposto esta caracterização de forma genérica.
%
Dessa forma, a linha de base para a caracterização será encontrada na própria análise, executando testes com poucas conexões, visando escalar igualitariamente para os usuários.
%
Esta linha de base será uma das contribuições que este trabalho pretende entregar.
...
%
Dessa forma, o atual trabalho também contribuirá com futuros trabalhos guiando o consumo de recursos para as arquiteturas Rudy, Salz e Willson.
%
