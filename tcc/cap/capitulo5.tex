...
%
As características das máquinas podem ser visualizadas na Tabela~\ref{tab:configuracao_das_maquinas_cliente}.

\begin{table}[htb!]
    \centering
    \begin{adjustbox}{max width=\textwidth}
        \caption{Configurações das máquinas virtuais do cliente.}
        \label{tab:configuracao_das_maquinas_cliente}
        \begin{tabular}{|l|l|l|l|}
        \hline
        Sistema Operacional            & \ac{cpu} & Memória  & Armazenamento \\ \hline
        Ubuntu LTS 18.04 Bionic Beaver & 8 Cores & 16 GB    & 1TB          \\ \hline
        Ubuntu LTS 18.04 Bionic Beaver & 8 Cores & 16 GB    & 1TB          \\ \hline
        Ubuntu LTS 18.04 Bionic Beaver & 8 Cores & 16 GB    & 1TB         \\ \hline
        Ubuntu LTS 18.04 Bionic Beaver & 8 Cores & 16 GB    & 1TB         \\ \hline
        Ubuntu LTS 18.04 Bionic Beaver & 8 Cores & 16 GB    & 1TB         \\ \hline
    ...
    Fonte: O próprio autor.
\end{table}
%ccm Não precisa de tabela, pode ser textual em um parágrafo. 

A Tabela~\ref{tab:configuracao_das_maquinas_cliente} mostra o aglomerado computacional.
%
