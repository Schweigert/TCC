...
%
Isto é necessário pois as escolhas técnicas, envolvendo estas a linguagem adotada, as tecnologias utilizadas e boas práticas aplicadas no desenvolvimento das aplicações, interferem na qualidade dos microsserviços, denotando-se qualidade como o consumo de recursos e desempenho das aplicações.
...
%
Além disso, a Seção~\ref{sec:tecnologias} apresenta o conjunto de serviços externos utilizados para facilitar o desenvolvimento dos microsserviços, que apesar de não estarem diretamente implementados na arquitetura das soluções, foram utilizados durante o processo e devem ser evidenciados.
