...
Durante o desenvolvimento da implentação, é utilizado a linguagem Golang, na qual ajudou a desenvolver de forma rápida e eficiente as aplicações para este trabalho.
...
%
Dessa forma, é utilizado o serviço TravisCI para realização de testes e build de imagens Docker.
%
