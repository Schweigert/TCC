...
\end{table}
%ccm Explicar o que é público a rede.
...
\begin{figure}[htb!]
  ...
  Fonte: O próprio autor.
\end{figure}
%ccm faltou apenas um TCP junto com HTTP na figura.
...
%ccm Escrever novamente o que são os testes 1,2 e 3. Rever Seção 4.3 porque nao há mais clientes na nuvem.
