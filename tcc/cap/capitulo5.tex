...
Entretanto no contexto dos testes faz sentido utilizar máquinas virtuais, de tal forma que pode-se executar scripts para acessar dados da máquina virtual e métricas do gestor de contêineres.
%
Essa forma tornamos o independente do ambiente físico real que está executando as aplicações.
