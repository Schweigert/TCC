...
%
O trecho de código que realiza esta operação é exibido na Figura~\ref{fig:seq_chars_redis}.


\begin{figure}[htb!]
    \caption{Código de geração de sequência de caracteres}
    \label{fig:seq_chars_redis}
...
O repositório de dados \textit{TokenRepository}\footnote{\textit{TokenRepository}: \url{https://github.com/schweigert/mmosandbox/blob/master/infra/merepositories/token_repositoriy.go}} contém as operações exibidas na Figura~\ref{fig:seq_chars_redis}.
%
