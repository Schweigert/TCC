...
%
Tal melhoria é apresentada pela economia de \ac{cpu} pela arquitetura Willson, a qual será apresentado na Sessão~\ref{sec:exp_cpu}, em função da quantidade de processos da arquitetura.
...
%
Entretanto, a arquitetura Salz não apresentou bons resultados quando comparados a tempo de resposta de \textit{chat} ou \textit{game}, por conta da saturação da \ac{cpu} nesta arquiteutra.
...
%
Tal tabela também exibe qual o valor mais otimizado, a partir do critério de tempo de resposta e consumo de recursos, ambos sendo minimizados.
%
