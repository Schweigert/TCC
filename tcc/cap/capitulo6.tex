...
%
Os dados são validados e o serviço retorna um dado assinado e armazenado, esse dados garantem a singularidade da sessão da conta.
...
%
Os dados capturados mostram que o tempo de resposta segue uma tendência linear conforme o crescimento dos jogadores, diferente das outras operações.
...
Nota-se que possuir um consumo de \ac{cpu} menor que outra arquitetura não implica em ser uma arquitetura melhor.
%
...
Percebe-se que o comportamento de vazão de saída da rede segue o mesmo padrão da entrada de rede para a rede de banco de dados, tal característica é visível ao comparar a Figura~\ref{fig:net_out_db} e \ref{fig:net_in_db}.
%
...
\hline \hline
\multicolumn{2}{l||}{Critério}                                                                          & Rudy        & Salz        & Willson & Otimizado    \\ \hline \hline
\multirow{7}{*}{\begin{tabular}[c]{@{}l@{}}Tempo\\ de Resposta\end{tabular}}  & Criar Conta           & Maior valor & Valor médio & Menor valor & Willson \\ \cline{2-6}
                                                                                & Criar Personagem      & Maior valor & Valor médio & Menor valor & Willson \\ \cline{2-6}
                                                                                & Iniciar Sessão        & Maior valor & Menor valor & Valor médio & Salz \\ \cline{2-6}
                                                                                & Instanciar Personagem & Valor médio & Maior valor & Menor valor & Willson \\ \cline{2-6}
                                                                                & Movimentar Personagem & Valor médio & Maior valor & Menor valor & Willson \\ \cline{2-6}
                                                                                & Enviar Mensagem       & Maior valor & Valor médio & Menor valor & Willson \\ \cline{2-6}
                                                                                & Receber Mensagem      & Maior valor & Valor médio & Menor valor & Willson \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Consumo\\ de CPU\end{tabular}}     & Banco de Dados        & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                                & Microsserviços        & Valor médio & Menor valor & Maior valor & Salz \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Consumo\\ de Memória\end{tabular}} & Banco de Dados        & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                                & Microsserviços        & Valor médio & Maior valor & Menor valor & Willson \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Entrada\\ de Rede\end{tabular}}    & Banco de Dados        & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                                & Microsserviços        & Menor valor & Valor médio & Maior valor & Rudy \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Saída\\ de Rede\end{tabular}}      & Banco de Dados        & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
...
\hline \hline
\multicolumn{2}{l||}{Critério}                                                                     & Rudy        & Salz        & Willson & Otimizado \\ \hline \hline
\multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Tempo\\ de Resposta\end{tabular}}  & Operações Web      & Maior valor & Valor médio & Menor valor & Willson \\ \cline{2-6}
                                                                              & Operação de Sessão & Maior valor & Menor valor & Valor médio & Salz\\ \cline{2-6}
                                                                              & Operações do Mundo & Valor médio & Maior valor & Menor valor & Willson \\ \cline{2-6}
                                                                              & Operações de Chat  & Maior valor & Valor médio & Menor valor & Willson \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Consumo\\ de CPU\end{tabular}}     & Banco de Dados     & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                              & Microsserviços     & Valor médio & Menor valor & Maior valor & Salz \\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Consumo\\ de Memória\end{tabular}} & Banco de Dados     & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                              & Microsserviços     & Valor médio & Maior valor & Menor valor & Willson \\ \hline \hline
\multicolumn{2}{l||}{Entrada de Rede}                                                              & Menor valor & Valor médio & Maior valor  & Rudy\\ \hline \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Saída\\ de Rede\end{tabular}}      & Banco de Dados     & Menor valor & Valor médio & Maior valor & Rudy \\ \cline{2-6}
                                                                              & Microsserviços     & Maior valor & Valor médio & Menor valor & Willson \\ \hline \hline
\end{tabular}
\end{adjustbox}
