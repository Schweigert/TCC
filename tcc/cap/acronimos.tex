...
\begin{acronym}[]
	\acro{acid}[ACID]{{Atomicidade, Consistência, Isolamento e Durabilidade}}
	\acro{amqp}[AMQP]{{\it Advanced Message Queuing Protocol}}
	\acro{api}[API]{{\it Application Programming Interface}}
	\acro{orm}[ORM]{{\it Object-Relational Mapping}}
	...
	\acro{dcc}[DCC]{{Departamento de Ciência da Computação}}
	\acro{ddos}[DDoS]{{\it Distributed Denial of Service}}
	\acro{fifo}[FIFO]{{\it First In First out}}
	\acro{fps}[FPS]{{\it First-Person Shooter}}
	\acro{gob}[GOB]{{\it Golang Object Encoding}}
	...
	\acro{vcpu}[VCPU]{{\it Virtual Central Process Unit}}
	...
	\acro{yaml}[YAML]{{\it YAML Ain't Markup Language}}
