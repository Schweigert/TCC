...
É comum serviços \ac{mmorpg} terem com funcionalidades parecidas.
%
Dessa forma, facilita a compreenção básica de forma genérica de um jogo \ac{mmorpg}, e auxilia a compreender o modelo computacional implementado nestes serviços.
%
...
%ccm Também não menciona os protocolos empregados
...
\begin{itemize}
  ...
  \item \textbf{Previsão de carga}: Projetar a carga futura sobre algum recurso a fim de escalar automaticamente a sua arquitetura na nuvem, a fim de reduzir gastos de alocações ociosas de servidor(es). %ccm tanto de flavor como de quantidade de instâncias
\end{itemize}
