...
\begin{figure}[htb!]
  ...
  Adaptado de:~\cite{matthiasrudy2011} e ~\cite{matthiasrudy2011}.
\end{figure}

Este modelo trabalha com um a padrão \textit{Thread Pool}~\cite{Ringler2014Dec, matthiasrudy2011}, executando a chamada de método remoto de cada jogador em uma fila, onde prioriza executar as chamadas sem repetir a mesma conexão.
%
...
%
O modelo de \textit{thread} do serviço de jogo pode ser visualizado na Figura~\ref{salz_thread_model}.



\begin{figure}[htb!]
  \caption{Modelo de Threads do serviço de jogo.}
  \label{salz_thread_model}
  \includegraphics[height=5.5cm]{arquiteturas/salz_thread_model.png}
  \centering

  Fonte:~\cite{salz_albion}.
\end{figure}



O microsserviço de jogo executa a lógica do jogo para uma única área em um único processo~\cite{salz_albion}.
%
