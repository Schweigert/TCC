...
%
Essa seção está presente a fim de definir algumas funcionalidades básicas que estão detro do contexto de jogabilidade de jogos \ac{mmorpg} para melhor compreensão de sua arquitetura em seções futuras.
...
Outro ponto a ser analisado é as arquiteturas utilizadas. Os trabalhos referentes a previsão de carga não utilizaram uma arquitetura de microsserviços, mesmo sendo um sistema distribuído.
%
