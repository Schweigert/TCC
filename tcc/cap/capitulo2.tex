...
%
Em desenvolvimento web é comum utilizar a abordagem de microsserviços (Seção \ref{sec:microsservicos}) para resolver o problema de sobrecarga, modularizando o  funcionamento em módulos menores.
%
