...
%
É por essa entrada de dados secundária na qual o serviço e o cliente podem se manter sincronizados~\cite{faber}. %ccm <-1
...
%
O foco de análise é o \textit{Game Server} e o \textit{Proxy Server}. %ccm <-14
