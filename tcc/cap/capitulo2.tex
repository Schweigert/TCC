...
Após a definição de conceitos básicos que permitam o compreendimento de funcionamento das arquiteturas de microsserviços para jogos \ac{mmorpg}, se faz necessário descrever os problemas a qual esta área tem, a fim que este trabalho contribua com futuras escolhas de projetos para jogos \ac{mmorpg}.
%ccm
