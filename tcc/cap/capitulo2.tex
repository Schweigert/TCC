...
O módulo de \textit{Network} implementado em um cliente de jogo \ac{mmorpg} é responsável por realizar as requisições conforme as ações requiridas pelo jogador ao serviço e aplicar os parâmetros na \textit{Scene Tree} por ordens do cliente~\cite{albion_online_unite}.
%
