...
\titulo{Análise e Caracterização do Tráfego na Rede de Controle de Nuvens Computacionais Baseadas em OpenStack Com Auxílio de um Sistema de Monitoramento}
\autor{Tiago Schoeping Reinert}
\nome{Tiago Schoeping}
\ultimonome{Reinert}

%---------- Informe o Curso e Grau -------------------------
\bacharelado \curso{Ciência da Computação} \mes{Novembro} \ano{2017}
...
\examinadorum{Rafael Rodrigues Obelheiro}
\examinadordois{Mauricio Aronne Pillon}
%\examinadortres{}
...
\input{cap/resumo}
\\
\noindent \textbf{Palavras-chaves:} Computação em nuvem, Caracterização de tráfego, Rede de controle, Sistema de monitoramento de tráfego, Análise de desempenho, OpenStack.
