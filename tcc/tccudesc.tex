...
\usepackage{pkg/lstlang0}

\lstset{
    language=Go, basicstyle=\ttfamily\scriptsize,
...
\bacharelado \curso{Ciência da Computação} \mes{Novembro} \ano{2019}
...
%--------- Lista de listagens ------------------------------
\renewcommand{\lstlistlistingname}{Listagem}
\lstlistoflistings
\thispagestyle{empty}
